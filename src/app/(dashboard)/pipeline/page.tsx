...
const pipelineSteps: PipelineStep[] = [
  {
    ...
    emoji: '🔍',
    name: 'Scraping DVF',
    description: 'Données immobilières IDF (95/92/93/60) via data.gouv.fr',
    status: 'functional',
    count: 309,
  },
  {
    ...
    emoji: '🎯',
    name: 'Filtrage',
    description: 'Maisons 500K-1.2M€, terrain >200m² (Méru: 200-600K€)',
    status: 'functional',
    count: 309,
  },
  {
    ...
    description: 'Google Maps Static API — zoom 19, 640×640',
    status: 'functional',
  },
  {
    id: 'ai',
    emoji: '🎨',
    name: 'Génération IA',
    description: 'Stability AI SDXL Inpainting — avant/après piscine',
    status: 'functional',
  },
  {
    id: 'email',
    emoji: '📧',
    name: 'Email',
    description: 'Brevo API — 300 emails/jour, RGPD compliant',
    status: 'functional',
  },
  {
    id: 'follow_up',
    emoji: '🔄',
    name: 'Suivi',
    description: 'Tracking ouvertures, clics et conversions',
    status: 'functional',
  },
];
...
const mockJobs = [
  {
    id: 'job_001',
    campaign: 'Piscines Val-d\'Oise (95)',
    type: 'collection',
    status: 'completed',
    progress: 100,
    started: '2026-04-13 08:30',
    completed: '2026-04-13 10:15',
    itemsProcessed: 309,
  },
  {
    id: 'job_002',
  ...
  {
    id: 'job_005',
    campaign: 'Piscines Hauts-de-Seine (92)',
    type: 'collection',
    status: 'completed',
    progress: 100,
    started: '2026-04-12 15:20',
    completed: '2026-04-12 17:30',
    itemsProcessed: 187,
  },
  {
    id: 'job_006',
    campaign: 'Piscines Méru (60)',
    type: 'collection',
    status: 'completed',
    progress: 100,
    started: '2026-04-12 17:31',
    completed: '2026-04-12 18:00',
    itemsProcessed: 24,
  },
]
